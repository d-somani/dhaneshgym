...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $membershipNumber = 'DG-' . str_pad(mt_rand(1, 999999), 6, '0', STR_PAD_LEFT);
...
<div class="wrapper">
    ...
    <footer class="main-footer">
        <strong> &copy; <?php echo date('Y');?> dhaneshsomani.com</a> -</strong>
        All rights reserved.
        <div class="float-right d-none d-sm-inline-block">
        <b>Developed By</b> <a href="https://dhaneshsomani.com/">DhaneshGYM</a>
        </div>
    </footer>
</div>
<!-- ./wrapper -->
